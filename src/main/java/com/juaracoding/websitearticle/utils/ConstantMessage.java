...
//    public final static String ERROR_DATE_FORMAT_DDMMYYYY = "FORMAT TANGGAL TIDAK SESUAI (dd-MM-YYYY)";
    ...
    public final static String WARNING_TITLEARTICLE_IS_EMPTY  = "JUDUL ARTIKEL TIDAK BOLEH KOSONG";
    public final static String WARNING_TITLEARTICLE_IS_NULL  = "JUDUL ARTIKEL TIDAK BOLEH NULL";
    public final static String WARNING_IMGARTICLE_IS_EMPTY  = "GAMBAR ARTIKEL TIDAK BOLEH KOSONG";
    public final static String WARNING_IMGARTICLE_IS_NULL  = "GAMBAR ARTIKEL TIDAK BOLEH NULL";
    public final static String WARNING_BODYRTICLE_IS_EMPTY  = "BODY ARTIKEL TIDAK BOLEH KOSONG";
    public final static String WARNING_BODYARTICLE_IS_NULL  = "BODY ARTIKEL TIDAK BOLEH NULL";
